...
function fn_searchFormMast(rowId) {
	...
	commonAjax({ "sBSeq": rowData.bSeq }, "/record/downloadhitory/selectDownHistList.do", function(returnData, textStatus, jqXHR) {
...
function fn_excel() {
	...
	var url = "/record/downloadhitory/selectDownHistExcelList.do";
